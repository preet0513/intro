...
public class AA extends Applet implements ActionListener
{
	...
	public void init()
	{
		...
		l1.setBounds(100,50,220,50);
		t1.setBounds(350,50,150,50);

		l2.setBounds(100,120,220,50);
		t2.setBounds(350,150,150,50);

		l3.setBounds(100,200,220,50);
		t3.setBounds(350,200,150,50);

		l4.setBounds(100,260,100,50);
		t4.setBounds(300,260,100,50);
